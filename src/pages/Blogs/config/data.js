export const blogList = [
  {
    ...
    content:
      ...
      features:[ "1. Predefined test procedure library: Access a comprehensive collection of predefined test procedures to streamline your experiments.",<br></br>,
      "2. Comprehensive test input and inventory management: Manage all aspects of your experiments with ease.",<br></br>,
      "3. Step-by-step digital work instructions: Execute experiments smoothly with clear instructions.",<br></br>,
      "4. Integrated test instruments: Collect data efficiently with integrated test instruments.",<br></br>,
      "5. Interactive charts for real-time tracking: Keep track of experiment progress in real-time.",<br></br>,
      "6. Advanced AI engine for automatic calculations and analysis: Leverage AI for automatic result analysis.",<br></br>,
      "7. Simplified test report generation: Generate compliant, ready-to-submit reports effortlessly.",<br></br>,
  ...
  },
  {
    ...
    content:
      ...
      features:[ "1. Capturing all Input and output Parameters: The first step to creating rich data is to capture all the input parameters that are part of the experiment. This includes conditions, product settings, environmental factors, and more. It allows for a deeper understanding of the context under which the experiment is running, giving rich insight into the influences on the test results.",<br></br>,
      "2. Real-time Observations during Testing: During the test run, making and recording observations in real-time allows for additional data points that can provide context for the test results. These observations could include anomalies, significant events, or just general performance metrics.",<br></br>,
      "3. Automated Processing for Run-Level Insights and Reports: Leveraging automation can significantly enhance the richness of data. Automated processing tools can extract run-level insights and generate comprehensive reports. These tools can flag significant events, highlight trends, and draw attention to specific results for further review, thereby enriching the overall dataset.",<br></br>,
  ...
  },
  {
    ...
    "2. Unity Hardware: Meet Unity, our advanced hardware module specially designed to interface with lab instruments and seamlessly connect to Testrunz. With its 20-channel capacity for thermocouple, AI, DI, DO measurements, and power product measurement features, Unity takes your experimentation process to a whole new level.",<br></br>,
    "3. TestRunZ Digital Experimentation: TestRunZ is the web-based application that revolutionizes the experimentation workflow by digitizing test steps, processing test data post-experimentation, and automatically generating detailed reports. Embrace a more efficient and data-driven approach to experimentation.",<br></br>,],
    cover: "/Asset/TestrunzMypage.png",
  },
  {
    id: 4,
    title:
      "AI-Powered Product Testing: Twinmo's Testrunz Solution",
    category: "Analysis",
  ...
  },
  {
    id: 6,
    title:
      "Embrace the Future of Product Testing with Twinmo's Testrunz",
    category: "Features",
    subCategory: ["Discover", "Verify", "Manufacture"],
    introduction:
    ...
    content:
    [ "1. Predefined Test Procedure Library: Unleash efficiency with our expansive, predefined procedure library, meticulously tailored for a seamless testing experience. With easy access to a variety of predefined test procedures, you can jumpstart your experiments and accelerate your product development.",<br></br>,
    "2. Comprehensive Test Input and Inventory Management:Optimize your workflows with our holistic test input and inventory management system. From managing test parameters to handling inventory, Testrunz ensures a well-organized and efficient testing process.",<br></br>,
    "3. Step-by-step Digital Work Instructions: Navigate your experiments with ease, courtesy of our detailed digital work instructions. Clear and intuitive instructions guide you through each step, eliminating confusion and promoting accuracy.",<br></br>,
    "4.Integrated Test Instruments for Time-Efficient Data Collection: Simplify data collection with our integrated testing instruments, designed for speedy and accurate results. Our platform seamlessly integrates with instruments, ensuring a seamless flow of data during the testing phase.",<br></br>,
    "5. Interactive Charts for Real-time Test Progress Tracking: Stay on top of your tests' progress with our interactive and dynamic charts. Monitor real-time data updates to make informed decisions quickly and effectively.",<br></br>,
    "6. Advanced AI Engine for Automatic Calculations and Results Analysis: Leave the heavy lifting to our advanced AI engine, which takes care of complex calculations and provides insightful results analysis. Focus on interpreting the data and deriving meaningful conclusions.",<br></br>,
